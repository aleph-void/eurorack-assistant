...
export const description = 'the physical arrangement a patch was built from';
...
export async function down({ dropTable }) {
  // The arrangement copied into these tables goes with them; the racks it was
  // copied from are untouched.
  await dropTable('patch_rack_row_modules', 'patch_rack_rows');
}
