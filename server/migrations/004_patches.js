...
export const description = 'patches: cables and settings against a rack snapshot';
...
export async function down({ dropTable }) {
  await dropTable('patch_settings', 'patch_cables', 'patch_modules', 'patches', 'component_values');
}
