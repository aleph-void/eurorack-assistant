...
export const description = 'jack pairs and what breaks a normal';
...
export async function down({ dropColumn, dropTable }) {
  await dropTable('component_pairs');
  await dropColumn('component_normalizations', 'break_component_id', 'break_on');
}
